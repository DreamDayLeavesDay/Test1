...
<div class="bgf5 clearfix">
    <div class="top-user">
        <div class="inner">
            <a class="logo" href="index.jsp"><img src="images/icons/logo.jpg" alt="" class="cover"></a>
            ...
            <form action="  " class="shopcart-form__box">
                <div class="addr-radio">
                    <div class="radio-line radio-box active">
                        ...
                        <a href="AddressEdit.jsp" class="edit">修改</a>
                    </div>
                ...
                <div class="add_addr"><a href="NewAddress.jsp">添加新地址</a></div>
